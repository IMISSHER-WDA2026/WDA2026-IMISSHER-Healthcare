...
- CHAT_MODEL_API_KEY
- HEALTHCARE_DATA_DIR
- HEALTHCARE_UPLOAD_DIR
- HEALTHCARE_MEDICINE_DATA_DIR
- HEALTHCARE_TEST_ACCOUNT_EMAIL
- HEALTHCARE_TEST_ACCOUNT_PASSWORD
- HEALTHCARE_TEST_ACCOUNT_FULL_NAME

Notes:
- Prefer RAG_MODEL_API_URL and RAG_MODEL_API_TOKEN for chatbot cloud inference.
- CHAT_MODEL_API_URL and CHAT_MODEL_API_KEY are still supported as backward-compatibility aliases.
